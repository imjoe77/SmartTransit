...
# Global FaceMesh instance + lock (thread-safe)
_face_mesh = None
...
def safe_process(face_mesh, image):
    """Thread-safe wrapper for MediaPipe processing."""
